...
@Component({
  selector: 'app-unloads',
  templateUrl: './unloads.component.html',
  styleUrls: ['./unloads.component.scss']
})
export class UnloadsComponent implements OnInit {
  ...
  addBtnUrl: string = '/app/lot-management/unloads-add';
  addBtnName: string = 'Créer un déchargement';
  editUrl: string = '/app/lot-management/unloads-edit/';
  deleteApis: apis;
  card_details: any[] = [];
    ...
    var dateList = [
      {
        finhe: '00001925',
        Spéculation: 'Cajou',
        Date_de_déchargement: '15/05/2021',
